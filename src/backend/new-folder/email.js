/**
 * E-Mails: Kontakt anlegen, danach Triggered Email.
 * HTML-Vorlage für Dashboard-Variable htmlSummary.
 */
    ...
    <tr><td style="padding:24px;">
      <table role="presentation" width="600" align="center" cellspacing="0" cellpadding="0" style="background:#ffffff;border-radius:12px;">
        ...
        <tr><td style="padding:24px;">
          ...
          <p>Die Ausstellung erfolgt nach fachlicher Prüfung. Bitte antworten Sie nicht auf diese Nachricht, falls es eine Systemmail ist – nutzen Sie die Kontaktadresse der Website.</p>
